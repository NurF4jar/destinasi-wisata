      ...
      <div class="container">
          ...
          <div class="card destinasi wow fadeInUp">
            ...
            <div class="card-body">
                  ...
                  <a href="" class="">Danau Toba</a>
                  <a href="" class="">Gunung Sibayak</a>
                  <a href="" class="">Pulau Nias</a>
                  <a href="" class="">Tangkahan</a>
                  <a href="" class="">Desa Tuktuk</a>
                    ...
                    <div id="slidedetail" class="carousel slide" data-ride="carousel">
                      <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item active">
                          <a href="<?php echo base_url(); ?>assets/images/sumut/sumut1.png" class="gallery-popup" title="<b>Pagoda Lumbini</b>, Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s">
                          <img class="d-block img-fluid" src="<?php echo base_url(); ?>assets/images/sumut/sumut1.png" alt=" ">
                            <div class="carousel-caption">
                              <p>
                                <b>Pagoda Lumbini</b>, Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s
                              </p>
                            </div>
                          </a>
                        ...
                        <div class="carousel-item">
                          <a href="<?php echo base_url(); ?>assets/images/sumut/sumut2.jpg="gallery-popup" title="<b>Pagoda Lumbini</b>, Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s ">
                          <img class="d-block img-fluid" src="<?php echo base_url(); ?>assets/images/sumut/sumut2.jpg" alt=" ">
                            <div class="carousel-caption">
                              <p>
                                <b>Pagoda Lumbini</b>, Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s
                        ...
                        <div class="carousel-item">
                          <a href="<?php echo base_url(); ?>assets/images/sumut/sumut3.jpg" class="gallery-popup" title="<b>Pagoda Lumbini</b>, Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s ">
                          <img class="d-block img-fluid" src="<?php echo base_url(); ?>assets/images/sumut/sumut3.jpg" alt=" ">
                            <div class="carousel-caption">
                              <p>
                                <b>Air Terjun</b>
                              </p>
                        ...
                        <div class="carousel-item">
                          <a href="<?php echo base_url(); ?>assets/images/sumut/sumut4.jpg" class="gallery-popup" title="<b>Orang Utan</b>">
                          <img class="d-block img-fluid" src="<?php echo base_url(); ?>assets/images/sumut/sumut4.jpg" alt=" ">
                            <div class="carousel-caption">
                              <p>
                                <b>Orang Utan</b>
                              </p>
                        ...
                        <div class="carousel-item">
                          <a href="<?php echo base_url(); ?>assets/images/sumut/sumut5.jpg" class="gallery-popup" title="<b>Danau Toba</b>, Danau kebanggan Orang sumatera Utara">
                          <img class="d-block img-fluid" src="<?php echo base_url(); ?>assets/images/sumut/sumut5.jpg" alt=" ">
                            <div class="carousel-caption">
                              <p>
                                <b>Danau Toba</b>, Danau kebanggan Orang sumatera Utara
                              </p>
                            </div>
                          </a>
                        </div>
                  ...
                  <div class="card box-shadow wow fadeInUp">
                    ...
                    <div class="card-body">
                      <p class="card-text">
                         ...
                         Arsitektur Rumah Batak,  dst.<br>
                         > Kepulauan Nias <br>
                         Atraksi lompat batu nias, dst.<br>
                         > Tangkahan - Bukit Lawang<br>
                         Treking, Caving, Tubing , Melihat Orang Utan Bukit Lawang, dst.<br>
                         > Kota Medan<br>
                         Istana Maimun, Rumah Tjong Afie, dst.<br>
                         > Berastagi, Kabanjahe<br>
                         Taman Simalem, Air terjun Sipiso Piso Tongging, dst.<br>
                         <br>
                         <b>Top 3 Calender of event  Sumut Tahun 2018 :</b><br>
                         Festival Danau Toba, Pekan Raya Sumatera Utara,  Festival Ya’ahowu Nias.
                       </p>
                    </div>
                    <div class="card-footer text-muted">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            <a href="<?php echo base_url(); ?>home/detail?id=" type="button" id="view" class="btn btn-sm btn-outline-secondary">View</a>
                            <?php
                            if ($name == 'admin') {
                              echo '<button type="button" class="btn btn-sm btn-outline-secondary"  data-toggle="modal" data-target="#modalform" data-whatever="Atraksi">Edit</button>';
                            }
                             ?>
                          </div>
                        </div>
                    ...
                    <div class="card-footer text-muted">
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                              ...
                              <?php
                              if ($name == 'admin') {
                                echo '<button type="button" class="btn btn-sm btn-outline-secondary"  data-toggle="modal" data-target="#modalform" data-whatever="Fasilitas">Edit</button>';
                              }
                               ?>
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            ...
                            <?php
                            if ($name == 'admin') {
                              echo '<button type="button" class="btn btn-sm btn-outline-secondary"  data-toggle="modal" data-target="#modalform" data-whatever="Aksesbilitas">Edit</button>';
                            }
                             ?>
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            ...
                            <?php
                            if ($name == 'admin') {
                              echo '<button type="button" class="btn btn-sm btn-outline-secondary"  data-toggle="modal" data-target="#modalform" data-whatever="Data Wisatawan">Edit</button>';
                            }
                             ?>
                          </div>
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            ...
                            <?php
                            if ($name == 'admin') {
                              echo '<button type="button" class="btn btn-sm btn-outline-secondary"  data-toggle="modal" data-target="#modalform" data-whatever="Kontribusi">Edit</button>';
                            }
                             ?>
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            ...
                            <?php
                            if ($name == 'admin') {
                              echo '<button type="button" class="btn btn-sm btn-outline-secondary"  data-toggle="modal" data-target="#modalform" data-whatever="Pengembangan Desa Wisata">Edit</button>';
                            }
                             ?>
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            ...
                            <?php
                            if ($name == 'admin') {
                              echo '<button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#modalform" data-whatever="Dokumen Perencanaan">Edit</button>';
                            }
                             ?>
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="btn-group">
                            ...
                            <?php
                            if ($name == 'admin') {
                              echo '<button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#modalform" data-whatever="Dana Lokasi Khusus (DAK)">Edit</button>';
                            }
                             ?>
